...
console.log(`PASS · ${checks} numerical comparisons; Gaussian mass and fixed-particle transport; continuity finite differences; 100 decreasing gradient updates.`);
console.log(`PASS · 3 generated pages; requested title; Gaussian drag figure and 3 analytic figures; unique IDs; ${localTargets.size} local files and assets.`);
